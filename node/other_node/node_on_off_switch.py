...
class Node(DpgNodeBase):
    ...
    def add_node(
        ...
        tag_switch_select_name = self._node_port_tag(node_id, self.TYPE_TEXT, 'Switch')
        tag_switch_select_value_name = self._node_value_tag(node_id, self.TYPE_TEXT, 'Switch')
